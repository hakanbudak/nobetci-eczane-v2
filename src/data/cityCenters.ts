export const CITY_CENTERS: Record<string, { lat: number; lng: number }> = {
    ...
    erzurum: { lat: 39.9054, lng: 41.2658 },
    sakarya: { lat: 40.6940, lng: 30.4358 },
    tekirdag: { lat: 41.0068, lng: 27.5115 },
    ...
    rize: { lat: 41.0208, lng: 40.5218 },
    agri: { lat: 39.7191, lng: 43.0503 },
    amasya: { lat: 40.6499, lng: 35.8353 },
    kutahya: { lat: 39.4168, lng: 29.9833 },
    ...
    karaman: { lat: 37.1815, lng: 33.2150 },
