...
export default function SeoFooterMessage({
    ...
    return (
        <div className="w-full bg-dark-950 border-t border-dark-800 text-dark-300 py-10 px-4 mt-0 shrink-0">
            <div className="max-w-4xl mx-auto space-y-6 text-sm leading-relaxed">
                <header>
                    <h1 className="text-xl md:text-2xl font-black text-dark-100 mb-4 tracking-tight">
                        {displayTitle}
                    </h1>
                </header>
                ...
                <p>
                    <strong>Nöbetçi Eczane Sistemi Nasıl Çalışır?</strong> Normal çalışma saatleri dışında veya resmi tatil / pazar
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-6 mt-6 border-t border-dark-800">
                    <p className="text-xs text-dark-500">
                        &copy; {new Date().getFullYear()} EczaneBul.co - Tüm hakları saklıdır. Sağlıklı günler dileriz.
                    </p>
                    <div className="flex items-center gap-4">
                        <a href="https://twitter.com/eczanebul" target="_blank" rel="noopener nofollow" className="text-dark-400 hover:text-primary-400 transition-colors" aria-label="Twitter">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                        </a>
                        <a href="https://instagram.com/eczanebul" target="_blank" rel="noopener nofollow" className="text-dark-400 hover:text-primary-400 transition-colors" aria-label="Instagram">
                        ...
                        <a href="https://facebook.com/eczanebul" target="_blank" rel="noopener nofollow" className="text-dark-400 hover:text-primary-400 transition-colors" aria-label="Facebook">
